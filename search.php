...
<!--    navigation-->
    <div id="myTabContent" class="tab-content">
        <div role="tabpanel" class="tab-pane fade in active" id="expeditions" aria-labelledby="expeditions-tab">
            <div class="agile-tp">
                <h2>Search Result For : <span class="text-primary"><?php echo $keyword?></h2>
            ...
            <?php } ?>
            <?php
            $sql1="SELECT * FROM products WHERE ProductName LIKE '%$keyword%' OR ProductSKU LIKE '%$keyword%' OR ProductLongDesc LIKE '%$keyword%' limit $offset,$limit";
                                    ...
                                    <figure>
                                        <div class="snipcart-item block" >
                                            <div class="snipcart-thumb">
                                                <a href="products.php"><img title=" " alt=" " src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['image']); ?>" /></a>
                                                ...
                                                <h4>$<?php echo $row['ProductPrice']?><span>$35.00</span></h4>
                                            </div>
